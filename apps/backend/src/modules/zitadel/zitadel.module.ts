...
export class ZitadelModule {
  ...
  static registerAsync(
    options: ZitadelModuleAsyncOptions,
    config: ZitadelModuleConfig = {},
  ): DynamicModule {
   ...
   */
  private static createGuardProviders(
    config: ZitadelModuleConfig,
  ): Provider[] {
  ...
  private static createAsyncProviders(
    ...
    const baseProviders: Provider[] = [ZitadelMiddleware];
  ...
  private static createAsyncOptionsProvider(
    ...
    return {
      provide: ZitadelModuleOptions,
      useFactory: async (optionsFactory: ZitadelOptionsFactory) =>
