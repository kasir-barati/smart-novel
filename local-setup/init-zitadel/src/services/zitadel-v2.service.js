...
/**
 * Service for interacting with ZITADEL V2 API endpoints
 */
export class ZitadelV2Service {
  /**
   ...
   */
  async enableImpersonation() {
    await fetch(`${this.baseUrl}/v2/features/instance`, {
      method: 'PUT',
      headers: {
        Authorization: `Bearer ${this.accessToken}`,
        'Content-Type': 'application/json',
